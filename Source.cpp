...
*/ 
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(-8.0f, -0.65f, 2.7f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(-8.0f, -1.95f, 2.7f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(-8.0f, -3.35f, 2.7f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(1.1f, -0.65f, 2.7f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(1.1f, -3.35f, 2.7f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(1.1f, -1.95f, 2.7f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(1.3f, -1.95f, -7.0f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(1.3f, -3.35f, -7.0f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(1.3f, -0.65f, -7.0f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(-8.0f, -0.65f, -7.0f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(-8.0f, -3.35f, -7.0f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
		...
		//set size, position and lighting shader
		model = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first		
		model = glm::translate(model, glm::vec3(-8.0f, -1.95f, -7.0f));
		model = glm::scale(model, glm::vec3(0.9f));
		lightingShader.setMat4("model", model);
		C.render();
